...
export default function BikeRunners() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center px-4">
      <div className="bg-gray-800 p-10 rounded-2xl shadow-xl text-center space-y-6">
        <h1 className="text-5xl font-bold text-yellow-400">🚴 Bike Runners</h1>
        <p className="text-gray-300 text-lg">Has entrado como <span className="text-yellow-400 font-semibold">Bike Runner</span></p>
